...
def upload_dir(dir_path=''):
    try:
        ...
        return 'Success! All files uploaded! Super!'
    except Exception as _ex:
        return 'Trouble, check your code please!'


def main():
    #print(create_and_upload_file(file_name='hello.txt', file_content='Hello Freands!'))
    print(upload_dir(dir_path='C:/work/g-drive/x-files'))
